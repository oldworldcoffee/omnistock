...
export const AuthProvider = ({ children }) => {
  ...
  // Returns true if the user has access to at least one commissary location
  const canAccessCommissary = () => {
    if (!userPermission) return true;
    if (userPermission.permissions?.all_locations) return true;
    const accessibleIds = userPermission.permissions?.location_ids || [];
    return allLocations.some(l => l.type === 'commissary' && accessibleIds.includes(l.id));
  };
